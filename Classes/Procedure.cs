...
{
    [Serializable]
    public class Procedure : Qualifiable
    {
        #region Fields
        ...
        public Procedure(Procedure Target)
            : this()
        {
            GhostCopy(Target);
        ...
        public override int GetHashCode()
        {
            ...
            {
                int result = 17;
                result = (result * 397) ^ ("Procedure").GetHashCode();
        ...
        /// <returns></returns>
        public Modification qualifyVersus(Procedure target, Direction dir)
        {
